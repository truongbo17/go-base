...
func CustomSwaggerWrapHandler() gin.HandlerFunc {
	return handleWrapHandler(swaggerFiles.Handler)
}

func handleWrapHandler(handler *webdav.Handler) gin.HandlerFunc {
	var once sync.Once
